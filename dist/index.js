...
const globby_1 = __nccwpck_require__(335);
const fs = __importStar(__nccwpck_require__(896));
function getFiles(workdir, patterns, options) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, globby_1.globby)(patterns.map((item) => {
            return workdir + item;
        }), options);
    });
}
...
const files_1 = __nccwpck_require__(115);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const files = (yield (0, files_1.getFiles)(workdir, patterns, { gitignore, ignoreFiles })).sort();
            let hash = '';
...
const crypto_1 = __importDefault(__nccwpck_require__(982));
const core = __importStar(__nccwpck_require__(484));
...
function hashHexAsync(content_1) {
    return __awaiter(this, arguments, void 0, function* (content, shaAlgorithm = 'sha256') {
